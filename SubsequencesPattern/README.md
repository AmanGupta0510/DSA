The question is asking about all the possible subsequences of n number of '0' and '1'.<br>

Approach 1 (Using recursion and backtracking ):- <br>
...
Time -> O(2^n) as we did 2^n recursive calls.<br>
